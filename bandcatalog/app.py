...
CLIENT_ID = '1017591567730-g8rls7jrmn3jme32lufstdc7ctt6opr8.apps.googleusercontent.com1017591567730-g8rls7jrmn3jme32lufstdc7ctt6opr8.apps.googleusercontent.com'
...
def login():
    ...
    blank = ''
    state = blank.join(random.choice(string.ascii_uppercase + string.digits) for x in range(32))
